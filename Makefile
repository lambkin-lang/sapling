...
$(RUNNER_MAILBOX_TEST_BIN): $(RUNNER_MAILBOX_TEST_SRC) $(RUNNER_MAILBOX_SRC) $(RUNNER_MAILBOX_HDR) $(RUNNER_LIFECYCLE_SRC) $(RUNNER_LIFECYCLE_HDR) $(RUNNER_WIRE_SRC) $(RUNNER_WIRE_HDR) $(SAPLING_SRC) $(SAPLING_HDR) $(WIT_GEN_SRC) $(WIT_GEN_HDR)
	$(CC) $(CFLAGS) $(INCLUDES) $(RUNNER_MAILBOX_TEST_SRC) $(RUNNER_MAILBOX_SRC) $(RUNNER_LIFECYCLE_SRC) $(RUNNER_WIRE_SRC) $(SAPLING_SRC) $(WIT_GEN_SRC) -o $(RUNNER_MAILBOX_TEST_BIN) $(LDFLAGS)

$(RUNNER_OUTBOX_TEST_BIN): $(RUNNER_OUTBOX_TEST_SRC) $(RUNNER_OUTBOX_SRC) $(RUNNER_OUTBOX_HDR) $(RUNNER_ATTEMPT_SRC) $(RUNNER_ATTEMPT_HDR) $(RUNNER_TXSTACK_SRC) $(RUNNER_TXSTACK_HDR) $(RUNNER_TXCTX_SRC) $(RUNNER_TXCTX_HDR) $(RUNNER_LIFECYCLE_SRC) $(RUNNER_LIFECYCLE_HDR) $(RUNNER_WIRE_SRC) $(RUNNER_WIRE_HDR) $(SAPLING_SRC) $(SAPLING_HDR) $(WIT_GEN_SRC) $(WIT_GEN_HDR)
	$(CC) $(CFLAGS) $(INCLUDES) $(RUNNER_OUTBOX_TEST_SRC) $(RUNNER_OUTBOX_SRC) $(RUNNER_ATTEMPT_SRC) $(RUNNER_TXSTACK_SRC) $(RUNNER_TXCTX_SRC) $(RUNNER_LIFECYCLE_SRC) $(RUNNER_WIRE_SRC) $(SAPLING_SRC) $(WIT_GEN_SRC) -o $(RUNNER_OUTBOX_TEST_BIN) $(LDFLAGS)
...
$(RUNNER_TIMER_TEST_BIN): $(RUNNER_TIMER_TEST_SRC) $(RUNNER_TIMER_SRC) $(RUNNER_TIMER_HDR) $(RUNNER_ATTEMPT_SRC) $(RUNNER_ATTEMPT_HDR) $(RUNNER_TXSTACK_SRC) $(RUNNER_TXSTACK_HDR) $(RUNNER_TXCTX_SRC) $(RUNNER_TXCTX_HDR) $(RUNNER_LIFECYCLE_SRC) $(RUNNER_LIFECYCLE_HDR) $(RUNNER_WIRE_SRC) $(RUNNER_WIRE_HDR) $(SAPLING_SRC) $(SAPLING_HDR) $(WIT_GEN_SRC) $(WIT_GEN_HDR)
	$(CC) $(CFLAGS) $(INCLUDES) $(RUNNER_TIMER_TEST_SRC) $(RUNNER_TIMER_SRC) $(RUNNER_ATTEMPT_SRC) $(RUNNER_TXSTACK_SRC) $(RUNNER_TXCTX_SRC) $(RUNNER_LIFECYCLE_SRC) $(RUNNER_WIRE_SRC) $(SAPLING_SRC) $(WIT_GEN_SRC) -o $(RUNNER_TIMER_TEST_BIN) $(LDFLAGS)

$(RUNNER_SCHEDULER_TEST_BIN): $(RUNNER_SCHEDULER_TEST_SRC) $(RUNNER_SCHEDULER_SRC) $(RUNNER_SCHEDULER_HDR) $(RUNNER_TIMER_SRC) $(RUNNER_TIMER_HDR) $(RUNNER_LIFECYCLE_SRC) $(RUNNER_LIFECYCLE_HDR) $(RUNNER_WIRE_SRC) $(RUNNER_WIRE_HDR) $(SAPLING_SRC) $(SAPLING_HDR) $(WIT_GEN_SRC) $(WIT_GEN_HDR)
	$(CC) $(CFLAGS) $(INCLUDES) $(RUNNER_SCHEDULER_TEST_SRC) $(RUNNER_SCHEDULER_SRC) $(RUNNER_TIMER_SRC) $(RUNNER_LIFECYCLE_SRC) $(RUNNER_WIRE_SRC) $(SAPLING_SRC) $(WIT_GEN_SRC) -o $(RUNNER_SCHEDULER_TEST_BIN) $(LDFLAGS)
...
$(WASI_SHIM_TEST_BIN): $(WASI_SHIM_TEST_SRC) $(WASI_SHIM_SRC) $(WASI_SHIM_HDR) $(WASI_RUNTIME_SRC) $(WASI_RUNTIME_HDR) $(RUNNER_LIFECYCLE_SRC) $(RUNNER_LIFECYCLE_HDR) $(RUNNER_WIRE_SRC) $(RUNNER_WIRE_HDR) $(SAPLING_SRC) $(WIT_GEN_SRC) $(WIT_GEN_HDR)
	$(CC) $(CFLAGS) $(INCLUDES) $(WASI_SHIM_TEST_SRC) $(WASI_SHIM_SRC) $(WASI_RUNTIME_SRC) $(RUNNER_LIFECYCLE_SRC) $(RUNNER_WIRE_SRC) $(SAPLING_SRC) $(WIT_GEN_SRC) -o $(WASI_SHIM_TEST_BIN) $(LDFLAGS)
