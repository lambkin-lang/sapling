...
SEQ_OBJ     = src/sapling/seq.o
TEST_SEQ_BIN = test_seq
...
$(TEST_SEQ_BIN): tests/unit/test_seq.o $(SEQ_OBJ)
	$(CC) $(CFLAGS) $(INCLUDES) tests/unit/test_seq.o $(SEQ_OBJ) -o $(TEST_SEQ_BIN) $(LDFLAGS)
