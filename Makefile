...
$(WASI_SHIM_TEST_BIN): $(WASI_SHIM_TEST_SRC) $(WASI_SHIM_SRC) $(WASI_SHIM_HDR) $(WASI_RUNTIME_SRC) $(WASI_RUNTIME_HDR) $(RUNNER_LIFECYCLE_SRC) $(RUNNER_LIFECYCLE_HDR) $(RUNNER_MAILBOX_SRC) $(RUNNER_MAILBOX_HDR) $(RUNNER_TIMER_SRC) $(RUNNER_TIMER_HDR) $(RUNNER_SCHEDULER_SRC) $(RUNNER_SCHEDULER_HDR) $(RUNNER_WIRE_SRC) $(RUNNER_WIRE_HDR) $(SAPLING_SRC) $(WIT_GEN_SRC) $(WIT_GEN_HDR)
	$(CC) $(CFLAGS) $(INCLUDES) $(WASI_SHIM_TEST_SRC) $(WASI_SHIM_SRC) $(WASI_RUNTIME_SRC) $(RUNNER_LIFECYCLE_SRC) $(RUNNER_MAILBOX_SRC) $(RUNNER_TIMER_SRC) $(RUNNER_SCHEDULER_SRC) $(RUNNER_WIRE_SRC) $(SAPLING_SRC) $(WIT_GEN_SRC) -o $(WASI_SHIM_TEST_BIN) $(LDFLAGS)
